...
#pragma region step3
	//download picture from internet using loadfrommemory
	eagleTexture = dlpicture("http://localhost", "Eagle.png");
	//airplane.setTexture(textures.get(Textures::Airplane));
	airplane.setTexture(eagleTexture);
...
//SFML doesn't support https!
//I am assuming you have download  Eagle.png under your localhost: C:\inetpub\wwwroot\

sf::Texture Game::dlpicture(std::string host, std::string uri)
{
	sf::Http http(host);
